...
RUN apt-get update -y && apt-get upgrade -y \
      ...
      && apt install -y --no-install-recommends sshpass nano net-tools curl apache2 sendmail crontab php8.1 libapache2-mod-php8.1 php8.1-mysql php8.1-curl php8.1-gd php8.1-intl \
